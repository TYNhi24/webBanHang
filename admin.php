...
<html>
<head>
	<title>4 GIRLS | Quản trị viên</title>
	<meta charset="utf-8">
      ...
      <hr width="500px">
		...
		<div class="page" style="text-align: center;">
			<table class="layout display responsive-table" >
				<body>
				<tr>
					<th class="actions"><a href="./taikhoan/quanlytk.php">Quản lý tài khoản</a><br></th>
				</tr>
				<tr>
					<th class="actions"><a href="./danhmuc/quanlydm.php">Quản lý danh mục</a><br></th>
				</tr>
				<tr>
					<th class="actions"><a href="./sanpham/quanlysp.php">Quản lý sản phẩm</a><br></th>
				</tr>
				<tr>
					<th class="actions"><a href="./donhang/quanlydh.php">Quản lý đơn hàng</a><br></th>
				</tr>
				<tr>
					<th class="actions"><a href="./chitietdonhang/quanlyctdh.php">Quản lý chi tiết đơn hàng</a></th>
				</tr>
			</table>
		</div>
	</div>
