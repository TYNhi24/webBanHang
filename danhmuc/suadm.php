<?php
session_start();
//kiểm tra xem yêu cầu có được gửi bằng phương thức POST hay không
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	//Lấy giá trị của trường 'tendanhmuc' từ dữ liệu được gửi qua phương thức POST và gán giá trị này cho biến $tendanhmuc
...
<head>
<head>
	<title>4 GIRLS | Sửa danh mục</title>
	<meta charset="utf-8">
				...
				<div class="row sm-gutter grid-content">
					...
					<div >
						<form action="" method="POST" >
							<table >
								<tr><td>Tên danh mục:     <input type="text" name="tendanhmuc" value="<?php echo $kq['tendanhmuc']; ?>"></td>	</tr>
